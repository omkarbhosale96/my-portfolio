...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Senior Software Engineer specializing in Java, Spring Boot, Microservices, Kafka and high-performance backend systems." },
      { name: "author", content: "Omkar Bhosale" },
      { property: "og:title", content: "Omkar Bhosale — Senior Java Backend Engineer" },
      { property: "og:description", content: "Building scalable systems and high-performance APIs with Java, Spring Boot & Microservices." },
